...
The file unigram.txt contains the counts of each of these tokens in a large text corpus from https://www.kaggle.com/datasets/rmisra/news-category-dataset.
